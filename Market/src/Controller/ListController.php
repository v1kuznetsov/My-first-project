...
class ListController extends AbstractController
{
    ...
    public function menuList(CategoryRepository $categoryRepository): Response
    {
    ...
    #[Route('/category/{category}', name: 'inCategory')]
    public function phoneList($category, ProductRepository $productRepository): Response
    {
